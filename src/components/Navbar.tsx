      ...
      <div className="container mx-auto flex items-center justify-between h-16 px-4">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link
            ...
            className="text-sm font-medium text-secondary-foreground/70 hover:text-primary transition-colors inline-flex items-center gap-1.5"
          >
          ...
          >
            <div className="flex flex-col gap-4 p-6">
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={() => setOpen(false)}
                className="bg-[#25D366] text-white px-5 py-2.5 rounded-md text-sm font-semibold text-center hover:opacity-90 transition-opacity inline-flex items-center justify-center gap-2"
              >
